			...
			<scroll-view scroll-y="true">
				...
				<view class="detail-like">
					...
					<view class="detail-comment">
						...
						<view class="detai l-comment-item" v-for="(item,index) in songComment" :key="index">
	...
	export default {
		...
		methods: {
			getMusic(songId) {
				...
				Promise.all([songDetail(songId), songSimi(songId), songComment(songId), songLyric(songId), 
