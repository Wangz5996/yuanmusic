		...
		<view class="container">
			<scroll-view  scroll-y="true">
				<view class="search-search">
						...
						<text v-show="searchType !=1" class="iconfont icon-guanbi11"></text>
				</view>
				...
				<block v-else-if="searchType==2">
					<view class="search-result">
						...
						<!-- <view class="search-result-item" v-for="(item,index) in searchList" :key="index">
							<view class="search-result-word">
								<view>{{ item.name }}</view>
								<view>{{ item.artist[0].name }} - {{ item.album.name }}</view>
							</view>
							<text class="iconfont icon-bofang"></text>
						</view>	 -->
...
<style scoped>
	.search-search{display: flex; align-items: center; height:70rpx; margin:70rpx 30rpx 50rpx 30rpx;background-color: #f7f7f7; 
	border-radius: 50rpx;}
	...
	.search-history-list view{padding:16rpx 28rpx; border-radius: 40rpx; margin-right:30rpx; margin-bottom: 30rpx;
background:#f7f7f7;}
	...
	.search-result-item{ display: flex;justify-content:space-between;align-items: center;padding-bottom: 30rpx;margin-bottom: 30rpx;
	...
	.search-suggest-head{color: #4574a4; margin-bottom:74rpx;}
