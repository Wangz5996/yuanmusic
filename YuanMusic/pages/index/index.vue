...
<style scoped>
	.index{}
	.index-search{display: flex; align-items: center; height: 70rpx; margin: 70rpx 30rpx 30rpx 30rpx; background-color: #f7f7f7; 
	border-radius: 50rpx;}
	.index-search text{font-size: 26rpx; margin-right: 26rpx;margin-left: 26rpx;}
	...
	.index-list-img text{position: absolute; left: 12rpx; bottom: 16rpx; color: #F1F1F1; font-size: 20rpx;}
