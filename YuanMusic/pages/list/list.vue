			...
			<scroll-view scroll-y="true">
				<view class="list-head">
					<view class="list-head-img">
						...
						<text class="iconfont icon-a-bofang1">{{ playlist.playCount | formatCount }}</text>
					</view>
					<view class="list-head-text">
						<view>榜单推荐</view>
						<view>
							<image src="../../static/M1.jpeg" mode=""></image> 元音乐
						</view>
						<view>
							元音乐榜单歌曲推荐，每日更新。
						</view>
				...
				<button class="list-share" open-type="share">
					<text class="iconfont icon-fenxiang">分享微信好友</text>
				</button>
				<!-- #endif -->
				...
				<view class="list-music">
					...
					<!-- <view class="list-music-item">
						...
						<text class="iconfont icon-a-bofang1"></text>
					</view> -->
...
<style scoped>
	...
	.list-share{width: 400rpx; height: 74rpx; margin: 0 auto; background: rgba(0,0,0,0.4); border-radius: 37rpx; color: white;
	text-align: center; line-height: 74rpx; font-size: 28rpx;}
	...
	.list-music-song view:nth-child(2){font-size: 20rpx; align-items: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;}
